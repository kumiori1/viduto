...
export default function Layout({ children, currentPageName }) {
  ...
  const metaMap = {
    home: {
      ...
      path: '/',
      image: 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68b4aa46f5d6326ab93c3ed0/e690cf3a8_IMG_6930.jpg' // Updated image URL
    },
    features: {
